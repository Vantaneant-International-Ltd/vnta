<script lang="ts">
	...
	const faqs = [
		...
		},
		{
			...
			a: 'You keep the system and the team. Optional retainers exist for continuity, oversight, or stewardship (invite-only at the top tier).'
		}
	];
</script>
...
<style>
	...
	/* FAQ (restore the old layout — only add the +) */
	.faq {
		display: flex;
		flex-direction: column;
		gap: 12px;
